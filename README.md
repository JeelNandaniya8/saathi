...
## Daily workspace update (15 September 2026)

Dashboard navigation now opens Today, Study, Care and Notes directly; other tools remain in More. Study supports up to 30 subject spaces, each with 300 owned links to chats, attachments, notes, mock tests and mindmaps. Deleting a subject never deletes its original resources; deleting an original removes its link automatically.

Wrong mock-test answers and flashcards marked Review again enter a private revision queue. Again schedules ten minutes, Hard one day, and Got it progresses through 1, 3, 7, 14 and 30 days. Version checks prevent stale or repeated answers from advancing a card twice. Include past work imports the most recent 100 tests and 100 flashcard sets without additional AI calls or resetting review dates.

Care offers a listening draft, a small step, and a preview of lower-priority dated tasks to move to tomorrow. Only explicitly selected tasks change; stale dates, changed priorities and changed timezone proposals are rejected. High-priority tasks and reminders remain as configured.
